...
decompose(11) must return [1,2,4,10]. Note that there are actually two ways to decompose 11^2, 11^2 = 121 = 1 + 4 + 16 + 100 = 1^2 + 2^2 + 4^2 + 10^2 but don't return [2,6,9], since 9 is smaller than 10.
...
The function "decompose" will take a positive integer n and return the decomposition of N = n^2 as:
